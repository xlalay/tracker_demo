...
from ...models.PromptVT.exemplar_transformer import ExemplarTransformer
from ...models.model_parts import *

from ...models.cross_attention_encoder.hierarchical_featurefusion_network import *
from ...models.PromptVT.DTP import DTP
import numpy as np
import time
...
class PromptVT(nn.Module):
    ...
    def forward_box_head(self, memory, softmax=True, run_cls_head=True , run_box_head=True, ):
        ...
        if "CORNER" in self.head_type:
            ...
            if run_box_head:
                outputs_coord = box_xyxy_to_cxcywh(self.box_head(fx_t))  # (B, 4, H_x*W_x)
